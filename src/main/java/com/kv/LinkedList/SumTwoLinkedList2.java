...
//    node cur;
//
//    // This function is called after the smaller list is added to the bigger lists's sublist of same size. Once
//    // the right sublist is added, the carry must be added to the left side of larger list to get the final result.
