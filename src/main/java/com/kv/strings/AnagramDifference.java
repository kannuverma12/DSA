...
public class AnagramDifference {
    ...
    private static int countManipulations(String s1, String s2) {
        ...
        for (int i = 0; i < s1.length(); i++) {
            ...
            // System.out.println("Char = "+s1.charAt(i)+", x : "+x+", x_ : "+x_+", char-a :
            // "+(s1.charAt(i) - 'a'));
        }

        // iterate through the second string update char_count. if character is not
        // found in char_count then increase count
